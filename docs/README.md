...
### Core Documentation
- **README_LLM.md** - System prompt and instructions for AI agents using Cortex Core
- **VALIDATION_GUIDE.md** - Guide for validating catalogs
- **MONTHLY_VALIDATION.md** - Monthly validation schedule and automation
